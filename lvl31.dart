...
import 'package:myapp/lvl32.dart';
        ...
        .map(
          (columns) => Column(
            ...
            children: columns.map((nr) {
              ...
              return AnswerBox(randomNumber, "c");
            }).toList(),
          ),
        )
        .toList();
    ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text(("Third letter of english alphabet"))));
    return Scaffold(
      ...
      if (widget._isPressed) {
        ...
        if (count == 0) {
          Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (context) => GamePage6()));
        }
      } else {
